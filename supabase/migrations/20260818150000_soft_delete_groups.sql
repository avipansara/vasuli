-- Keep deleted groups and their financial history recoverable, matching
-- Splitwise-style delete/undelete behavior.
...
BEGIN
  ...
  all_impacts AS (
    ...
    UNION ALL
    SELECT group_id, impact_amount FROM settlement_impacts
  ),
  balances AS (
