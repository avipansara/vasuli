      ...
      <View style={styles.inputWrapper}>
        <View
          ...
          <IconSymbol
            name="person.fill"
            size={18}
            color={focusedField === 'name' ? (isDark ? '#2DD4BF' : '#22C55E') : (isDark ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)')}
          />
          <TextInput
        ...
        <ScrollView
          ...
          <Animated.View
            ...
            <Text style={[styles.appName, { color: isDark ? '#fff' : colors.text }]}>
              {step === 'contact' ? 'Join Vasuli' : 'Verify Your Account'}
            </Text>
            <Text style={[styles.tagline, { color: isDark ? 'rgba(255,255,255,0.6)' : colors.textSecondary }]}>
              {step === 'contact' ? 'Create your account in seconds' : 'Enter the code we sent you'}
            </Text>
          </Animated.View>
