...
export const InvitationsTheme = {
  light: {
    ...
    pending: '#F59E0B',
    pendingSurface: 'rgba(245, 158, 11, 0.12)',
  ...
  dark: {
    ...
    primaryActionText: '#0A0A0F',
    pending: '#F59E0B',
    pendingSurface: 'rgba(245, 158, 11, 0.2)',
...
export const FriendDetailTheme = {
  light: {
    ...
    backgroundAccentMiddle: 'rgba(167, 139, 250, 0.06)',
    backgroundAccentBottom: 'rgba(45, 212, 191, 0.05)',
    activityTitle: TEXT_LIGHT,
    activitySecondary: TEXT_SECONDARY_LIGHT,
    activityBadgeSurface: '#E5E7EB',
    activityShadow: '#475569',
    dialogSecondarySurface: '#F3F4F6',
    dialogSecondaryBorder: 'transparent',
  },
  dark: {
    ...
    activityTitle: TEXT_DARK,
    activitySecondary: TEXT_SECONDARY_DARK,
    activityBadgeSurface: 'rgba(30, 41, 59, 0.6)',
    activityShadow: '#64748b',
    dialogSecondarySurface: '#1E293B',
    dialogSecondaryBorder: 'transparent',
